...
If you want a clean state while using the fake backend, clear site data in your browser or remove the local storage key:
...
- Clear browser storage for the site, or remove the local storage key:
  - `angular-15-verification-boilerplate-accounts`
